...
// * DAC defintions
#define DAC_SCK 	BIT2		// PORT 4.2 - Posedge triggered
#define DAC_SDI 	BIT3		// PORT 4.0
#define DAC_LATCH 	BIT4		// PORT 4.4	- Active LOW
#define DAC_CS 	BIT5		// PORT 4.5
...
#define ADC_SDO 	BIT4		// SDO (ADC converted data 16-bit (2LSB Don't care)
#define ADC_BUSY 	BIT0		// If LOW, then ADC is busy
#define PORT_ADC 	P6OUT		// ADC PORT: P6.X
...
void initPorts () {
	...
	P6DIR |= ADC_SCK + ADC_SDI + ADC_CONVST;			// configure ADC_* pins as output
	P6DIR &= ~ADC_SDO; 									// configure ADC_SDO pin as input
}
